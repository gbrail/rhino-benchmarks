...
//Turn on sound.
false,
//Boot with boot ROM first? (set to false for benchmarking)
false,
...
0x10,
//Internal audio buffer pre-interpolation factor.
1 //Volume level set.
];
...
var Benchmark = /*#__PURE__*/function () {
  function Benchmark() {
    ...
    _defineProperty(this, "EXPECTED_RESULT_HASH", 439041103);
  }
  return _createClass(Benchmark, [{
    ...
    value: function validate() {
      if (this.result != this.EXPECTED_RESULT_HASH) throw new Error(`Got unexpected result hash ${this.result} instead of ${this.EXPECTED_RESULT_HASH}`);
    }
  }]);
}();
