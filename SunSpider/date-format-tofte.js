...
Date.prototype.formatDate = function (input, time) {
  ...
  var formatters = {
    ...
    d() {
      ...
      return String(self.getDate()).length == 1 ? "0" + self.getDate() : self.getDate();
    },
    D() {
    ...
    H() {
      ...
      return String(self.getHours()).length == 1 ? "0" + self.getHours() : self.getHours();
    },
    i() {
      // Minutes with leading zeros
      return String(self.getMinutes()).length == 1 ? "0" + self.getMinutes() : self.getMinutes();
    },
    j() {
    ...
    s() {
      ...
      return String(self.getSeconds()).length == 1 ? "0" + self.getSeconds() : self.getSeconds();
    },
    t() {
...
var Benchmark = /*#__PURE__*/function () {
  function Benchmark() {
    ...
    _defineProperty(this, "EXPECTED_RESULT_HASH", 439041101);
  }
  return _createClass(Benchmark, [{
    key: "runIteration",
    value: function runIteration() {
      this.resultHash = 0x1a2b3c4d;
      for (var _i = 0; _i < 8; ++_i) this.resultHash ^= run();
    }
  }, {
    key: "validate",
    value: function validate() {
      if (this.resultHash != this.EXPECTED_RESULT_HASH) throw new Error(`Got unexpected result hash ${this.resultHash} instead of ${this.EXPECTED_RESULT_HASH}`);
    }
  }]);
}();
