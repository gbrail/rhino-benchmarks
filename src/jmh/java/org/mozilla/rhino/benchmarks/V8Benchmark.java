package org.mozilla.rhino.benchmarks;
...
public class V8Benchmark {
    ...
    abstract static class AbstractState {
        ...
        void evaluateSource(Context cx, Scriptable scope, String path) {
            try {
                try (InputStream is = V8Benchmark.class.getClassLoader().getResourceAsStream(path)) {
                    if (is == null) {
                        throw new RuntimeException("Can't find resource " + path);
                    }
                    try (InputStreamReader rdr = new InputStreamReader(is)) {
                        cx.evaluateReader(scope, rdr, path, 1, null);
        ...
        void initialize(boolean interpreted) {
            ...
            evaluateSource(cx, scope, "framework.js");
        }
    ...
    public static class SplayState extends AbstractState {
        ...
        public void setUp() {
            ...
            evaluateSource(cx, scope, "v8/splay.js");
            runSetup();
    ...
    public static class CryptoState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/crypto.js");
            runSetup();
    ...
    @Benchmark
    public Object cryptoEncrypt(CryptoState state) {
    ...
    public static class DeltaBlueState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/deltablue.js");
            runSetup();
    ...
    public static class RayTraceState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/raytrace.js");
            runSetup();
    ...
    public static class RegExpState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/regexp.js");
            runSetup();
    ...
    public static class RichardsState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/richards.js");
            runSetup();
    ...
    public static class EarleyBoyerState extends AbstractState {
        ...
        public void setUp() {
            initialize(interpreted);
            evaluateSource(cx, scope, "v8/earley-boyer.js");
            runSetup();
